...
export const Register: React.FC = () => {
  const { register, handleSubmit, errors, isLoading, errorMsg } = useRegister();
      ...
      <div className="w-full max-w-md z-10">
        <div className="text-center mb-8">
          ...
          <p className="mt-2 text-sm text-slate-400">
            Start algo trading and options analysis with Kronos
          </p>
        </div>
        ...
        <Card className="border-slate-800/80 bg-slate-900/50 backdrop-blur-xl p-8">
          ...
          <p className="mt-6 text-center text-sm text-slate-400">
            ...
            <Link to="/login" className="text-blue-500 hover:text-blue-400 font-semibold transition-colors duration-150">
              Sign In
            </Link>
          </p>
        </Card>
